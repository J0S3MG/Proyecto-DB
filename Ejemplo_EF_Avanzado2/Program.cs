...
using Ejemplo_EF_Avanzado2.Data.Repositories;
using Ejemplo_EF_Avanzado2.Services;
using Ejemplo_EF_Avanzado2.Services.Interfaces;
using Ejemplo_EF_Avanzado2.Services.Interfaces.Repositories;
using Ejemplo_EF_Avanzado2.Data.UnitOfWorks;
...
builder.Services.AddScoped<IEjemploUoW, EjemploUoW>();
