...
public class AlumnoController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<IActionResult> Get(int pagina = 1, int tamanioPagina = 10, [FromQuery] AlumnoFiltro? filtro = null)
    {
        try { return Ok(await _alumnoService.GetAll(pagina, tamanioPagina, filtro)); }
